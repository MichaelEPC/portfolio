      ...
      <div className="h-[750px] w-full flex items-center justify-center">
        <div>
          <h1 className="font-semibold text-5xl mt-10 text-principal-color">
            <span className="text-black">¡</span>Michael Posada{" "}
          ...
          <div className="border-t-2 border-principal-color mt-2">
            <p className="h-auto w-[700px] text-lg mt-1">
          ...
          <div className="h-auto w-full flex items-center mt-1">
            <div className="rounded-full p-1 border-2 border-slate-400 bg-slate-500 cursor-pointer">
              <svg
            ...
            <div className="rounded-full ml-2 p-1 border-2 border-slate-400 bg-slate-500 cursor-pointer">
              <svg
                className="fill-white"
                xmlns="http://www.w3.org/2000/svg"
                width="42"
